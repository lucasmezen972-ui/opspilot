...
export function getDemoActions(): CorrectiveAction[] {
  return [
    ...
    },
    {
      ...
      resolved_at: days(-2),
      resolution_comment:
        'Étiquettes allergènes réimprimées et reposées sur les 3 références snacking concernées.',
      resolved_by_name: 'Jean Martin',
      resolved_by_matricule: 'M-2207',
    ...
    },
    {
      ...
      resolved_at: days(-5),
      resolution_comment:
        'Session réalisée avec 6 collaborateurs ; émargement signé et plan de nettoyage affiché en réserve.',
      resolved_by_name: 'Marie Dupont',
      resolved_by_matricule: 'M-1042',
      resolution_photo_confirmed: false,
      manager_validated: true,
      resolved_by: DEMO_USER_ID,
      resolver_role: 'manager',
      created_by: DEMO_USER_ID,
